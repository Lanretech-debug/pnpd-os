...
source_scaffold_section: "## OWNER_DECISION_PROMPT Scaffold"
owner: Owner
target_agent: Owner
...
OWNER_DECISION_PROMPT surfaces verified state to the Owner for approve, request changes, or block. It grants no execution authority to any agent. It preserves Owner as final authority.
...
Source scaffold section: ## OWNER_DECISION_PROMPT Scaffold
